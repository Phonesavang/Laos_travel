...
class Siokhdtabong extends StatefulWidget {
  @override
  State<Siokhdtabong> createState() => _SiokhdtabongState();
}

class _SiokhdtabongState extends State<Siokhdtabong> {
  // const ChiangThong({super.key});
  List<String> item = [
    "asset/img/Siokhdtabong_2.jpg",
    "asset/img/Siokhdtabong_3.jpg",
    "asset/img/Siokhdtabong_4.jpg",
    "asset/img/Siokhdtabong_5.jpg",
    "asset/img/Siokhdtabong_6.jpg",
  ];

  String bg = "asset/img/C22.JPG";
