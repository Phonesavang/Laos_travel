...
class Phuphaman extends StatefulWidget {
  @override
  State<Phuphaman> createState() => _PhuphamanState();
}

class _PhuphamanState extends State<Phuphaman> {
  // const ChiangThong({super.key});
  List<String> item = [
    "asset/img/Phuphaman_2.jpg",
    "asset/img/Phuphaman_3.jpg",
    "asset/img/Phuphaman_4.jpg",
    "asset/img/Phuphaman_5.jpg",
    "asset/img/Phuphaman_6.jpg",
  ];

  String bg = "asset/img/C21.JPG";
